...
import ishredder from '../assets/ishredderImgs/logo.jpg';
				...
				<div className="content">
					<Link to="/applications/Eset">
						<div className="card">
							...
							<img className="card-img" src={eset} alt="eset" />
					...
					<Link to="/applications/Veracrypt">
						<div className="card">
							...
							<img className="card-img" src={veraCrypt} alt="veracrypt" />
					...
					<Link to="/applications/Eraser">
						<div className="card">
							<h4>Eraser - ايرسير </h4>
							<img className="card-img" src={eraser} alt="eraser" />
							<p>الحذف الآمن للبيانات</p>
						</div>
					</Link>
					<Link to="/applications/Ishredder">
						<div className="card">
							<h4>iShredder - آي شريدير </h4>
							<img className="card-img" src={ishredder} alt="ishredder" />
							<p>الحذف الآمن للبيانات على أجهزة الموبايل</p>
						</div>
					</Link>
					<Link to="/applications/Bitwarden">
						<div className="card">
							<h4>Bitwarden - بت واردن</h4>
							<img className="card-img" src={bitwarden} alt="bitwarden" />
					...
					<Link to="/applications/Authy">
						<div className="card">
							<h4>Authy - أوثي</h4>
							<img className="card-img" src={authy} alt="authy" />
					...
					<Link to="/applications/MicrosoftAuth">
						<div className="card">
							...
							<img className="card-img" src={microAuth} alt="microsoft-auth" />
					...
					<Link to="/applications/Nord">
						<div className="card">
							...
							<img className="card-img" src={nordvpn} alt="nordvpn" />
					...
					<Link to="/applications/Workspace">
						<div className="card">
							...
							<img className="card-img" src={workspace} alt="workspace" />
					...
					<Link to="/applications/Mailvelope">
						<div className="card">
							...
							<img className="card-img" src={mailvelope} width="200px" alt="mailvelope" />
					...
					<Link to="/applications/Jitsi">
						<div className="card">
							<h4>Jitsi - جيتسي</h4>
							<img className="card-img" src={jitsi} alt="jitsi" />
					...
					<Link to="/applications/Zoom">
						<div className="card">
							<h4>Zoom - زووم</h4>
							<img className="card-img" src={zoom} alt="zoom" />
							<p>منصة تواصل اجتماعي آمن - مكالمات فيديو</p>
						</div>
					</Link>
					<Link to="/applications/Other">
						<div className="card">
							...
							<img className="card-img" src={other} alt="other" />
