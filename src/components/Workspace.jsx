		...
		<div class="main workspace">
			<div class="container">
				...
				<div class="content content-2 info" id="gmail">
					...
					<ul class="child-list new">
						...
						الإلكتروني <br />
						<img src="./assets/workspaceImgs/gmail1.png" alt="one" />
						<li>
							لكتابة إيميل جديد وإرساله أو لتصفح البريد المرسل أو الوارد <br />
							<img src="./assets/workspaceImgs/gmail2.png" alt="two" />
						</li>
						<li>
							...
							<br />
							<img src="./assets/workspaceImgs/gmail3.png" alt="three" />
						</li>
						<li>
							لإنشاء غرفة محادثة جديدة أو للانضمام إلى غرفة موجودة مسبقاً <br />
							<img src="./assets/workspaceImgs/gmail4.png" alt="four" />
						</li>
						<li>
							{' '}
							للذهاب إلى Google Meet لإنشاء اتصال أو مكالمة فيديو
							<img src="./assets/workspaceImgs/gmail5.png" alt="five" />
						</li>
					</ul>
				</div>
					...
					<ul class="child-list new">
						...
						<li>
							<ul class="child-list">
								...
								<img src="./assets/workspaceImgs/cal1.png" alt="one" />
							</ul>
						</li>
						<li>
							<span>
							...
							<ul class="child-list">
								...
								<img src="./assets/workspaceImgs/cal2.png" alt="two" />
								<li>
									...
									<ul class="child-list">
										...
										<img src="./assets/workspaceImgs/cal4.png" alt="four" />
									</ul>
								</li>
							</ul>
						</li>
				...
				<ul class="child-list new">
					...
					<li>
						<ul class="child-list">
							...
							<img src="./assets/workspaceImgs/meet1.png" alt="one" />
						</ul>
					</li>
					<li>
						<span>
						...
						<ul class="child-list">
							<li>
								لإنشاء اجتماع في وقت لاحق، ثم أخذ الرابط الذي يظهر في النافذة وإرساله إلى
								من الأشخاص المنضمين
							</li>
				...
				<ul class="child-list new">
					...
					<li>
						<ul class="child-list">
							...
							<li>سلة المهملات</li>
							<img src="./assets/workspaceImgs/drive1.png" alt="one" />
						</ul>
					</li>
					<li>
						<span>
						...
						<ul class="child-list">
							...
							<img src="./assets/workspaceImgs/drive2.png" alt="two" />
						</ul>
					</li>
					<li>
						<span>
							لمشاركة ملف مع شخص آخر، نضغط بزر الفأرة اليمين على الملف، ونختار مشاركة كما
							الصروة التالية:
						</span>{' '}
						<br />
						<ul class="child-list">
							<img src="./assets/workspaceImgs/drive3.png" alt="three" />
						</ul>
					</li>
					<li>
						...
						<ul class="child-list">
							...
							<li>
								"المركز السوري للإعلام وحرية التعبير": وتعني أن أي شخص ينتمي للمركز يستطيع
								فتح الملف
							</li>
							<li>
								"أي شخص لديه الرابط": وتعني أن أي شخص يحصل على رابط الملف يستطيع فتحه
							</li>
							<img src="./assets/workspaceImgs/drive4.png" alt="four" />
						</ul>
					</li>
					<li>
						<span>بعد تحدد الأشخاص الذين نريد المشاركة معهم، تظهر النافذة التالية:</span>{' '}
						<br />
						<ul class="child-list">
							...
							<img src="./assets/workspaceImgs/drive5.png" alt="five" />
						</ul>
					</li>
				</ul>
			</div>
			...
			<div class="content content-2 info" id="chat">
				...
				<ul class="child-list new">
					...
					<img src="./assets/workspaceImgs/chat1.png" alt="one" />
				</ul>
				{/* </li> */}
				<li>
					...
					<ul class="child-list new">
						...
						<img src="./assets/workspaceImgs/chat2.png" alt="two" />
					</ul>
				</li>
				{/* </ul> */}
			</div>
